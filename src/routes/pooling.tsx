          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground mt-1">
                Higher overlap means bigger splits and less detour.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 p-4 bg-background rounded-lg border border-border">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-lg font-bold text-success">
                ₹{calc.saved} ({((calc.saved / baseFare) * 100).toFixed(0)}%)
              </span>
            </div>
          </div>
        </Card>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <Card className="flex flex-col">
              ...
              <div
                className="relative w-full aspect-[2/1] rounded-md border border-border bg-[#E5E3DF] dark:bg-[#1a1f2c] overflow-hidden"
              ...
              >
                ...
                >
                  ...
                  {/* Water / River */}
                  <path
                    d="M -50 250 Q 150 200 300 350 T 650 100 L 650 350 L -50 350 Z"
                    fill="#AADAFF"
                    className="dark:fill-[#1e293b]"
                    opacity="0.6"
                  />
                  <path
                    d="M -50 220 Q 150 170 300 320 T 650 70 L 650 150 Q 400 350 250 250 T -50 280 Z"
                    fill="#99C2FF"
                  ...
                  {/* Parks */}
                  <path
                    d="M 50 20 Q 120 -10 180 40 Q 200 100 130 120 Q 60 140 30 80 Z"
                    fill="#C8E6C9"
                    className="dark:fill-[#064e3b]"
                    opacity="0.5"
                  />
                  <path
                    d="M 400 180 Q 480 150 520 220 Q 550 280 480 300 Q 400 310 380 240 Z"
                    fill="#C8E6C9"
                    className="dark:fill-[#064e3b]"
                    opacity="0.5"
                  />
                  ...
                  {/* Minor Roads */}
                  <path
                    d="M 0 50 L 600 80 M 0 150 L 600 120 M 0 250 L 600 280 M 100 0 L 80 300 M 300 0 L 320 300 M 500 0 L 480 300"
                    stroke="#FFFFFF"
                  ...
                  />
                  <path
                    d="M 50 0 L 150 300 M 250 0 L 180 300 M 450 0 L 550 300 M 0 100 L 600 180 M 0 200 L 600 220"
                    stroke="#FFFFFF"
                    className="dark:stroke-[#334155]"
                    strokeWidth="2"
                    fill="none"
